      ...
      <form onSubmit={handleSubmit} style={{minWidth: "40rem"}}>
        <div className="row mb-3">
          ...
          <div className="col-sm-10">
            <input type="text" value={adminName} onChange={(e)=> setName(e.target.value)} className="form-control" id="inputEmail3" placeholder="Enter Employee Name Here..." />
          </div>
        </div>
        <div className="row mb-3">
        ...
        <div className="row mb-3">
          ...
          <div className="col-sm-10">
            <input
              ...
              className="form-control"
              id="inputPassord4"
              placeholder="Enter Employee Educational background.."
            />
          </div>
        </div>
        <div className="row mb-3">
          ...
          <div className="col-sm-10">
            <input
              ...
              className="form-control"
              id="inputPassord5"
              placeholder="Enter Employee LinkedIn Url.."
            />
          </div>
        </div>
        <div className="row mb-3">
        ...
        <div className="row mb-3">
          ...
          <div className="col-sm-10">
            <input
              ...
              className="form-control"
              id="inputPasswor"
              placeholder="please upload Employee photo here.."
            />
          </div>
        </div>
